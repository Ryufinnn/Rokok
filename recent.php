<?php
$sqlproduk = mysql_query("SELECT member.username, produk.idproduk, namaproduk, deskripsi, harga, stok, (produk.foto)as photo FROM recent, produk, member where produk.idproduk=recent.idproduk and member.username=recent.username and member.username='$_SESSION[user1]' order by tglrecent desc limit 0,2");
