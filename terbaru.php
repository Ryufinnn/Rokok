<?php
$sqlproduk = mysql_query("SELECT * FROM produk order by tglmasuk desc limit 0,2");
...
<div style="margin-left:5px; margin-right:5px; margin-top:22px;"><div class="prod_box">
        <div class="center_prod_box">
          ...
          <div class="product_img"><a href="#"><img src="admin/produk/<?php echo"$rproduk[foto]"; ?>" alt="" border="1" width="160" height="120"/></a></div>
        </div>
